                                            ...
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <div class="d-inline">
                                                        ...
                                                        <span>faites un choix <code>5</code> ou 3 </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                   <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">Fiche de voeux</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <span>ici  <code>1-2-3-4-5</code> ici </span>
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select name="select" class="form-control">
                                                                    <option value="opt1">Selectionner Sujet</option>
