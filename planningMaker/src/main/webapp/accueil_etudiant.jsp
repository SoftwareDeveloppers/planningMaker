							...
							<div class="row">
								...
								<div class="col-sm-8 user-detail">
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30">
												<i class="icofont icofont-ui-user"></i>Name :
											</h6>
										</div>
										<div class="col-sm-7">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30">
												<i class="icofont icofont-ui-calendar"></i>Date of brith :
											</h6>
										</div>
										<div class="col-sm-7">
									...
									<div class="row">
										...
										<div class="col-sm-7">
											<h6 class="m-b-30">
												<a href="mailto:dummy@example.com">techdemo@example.com</a>
											</h6>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30">
												<i class="icofont icofont-ui-home"></i>Address :
											</h6>
										</div>
										<div class="col-sm-7">
											<h6 class="m-b-30">23/Encrypt square, Melbourn,
												Australia</h6>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30">
												<i class="icofont icofont-ui-touch-phone"></i>Phone :
											</h6>
										</div>
										<div class="col-sm-7">
									...
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30">
												<i class="icofont icofont-fax"></i>Fax :
											</h6>
										</div>
										<div class="col-sm-7">
