                                                        ...
                                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                                            ...
                                                            <div class="carousel-inner" role="listbox">
                                                                <div class="carousel-item active">
                                                                    <img class="d-block img-fluid w-100" src="assets/images/agenda-journee-reussir-2018-02-27.jpg" alt="First slide">
                                                                </div>
                                                                <div class="carousel-item">
                                                                    <img class="d-block img-fluid w-100" src="assets/images/post_it_note_make__3015148b.jpg" alt="Second slide">
                                                                </div>
                                                                <div class="carousel-item">
                                                                    <img class="d-block img-fluid w-100" src="assets/images/3ec7c5c0de932bc_file.jpg" alt="Third slide">
                                                                </div>
                                                                <div class="carousel-item">
                                                                    <img class="d-block img-fluid w-100" src="assets/images/thumb_835_article_retina.jpeg" alt="Third slide">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-7">
                                                <div class="card">
                                                    <div class="card-block user-detail-card">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <img src="assets/images/avatar-4.jpg " alt="" class="img-fluid p-b-10"/>
