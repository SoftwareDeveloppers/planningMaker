							...
							<div class="col-lg-8">
								<div class="page-header-title">
									...
									<div class="d-inline">
										...
										<span>Vous devez remplir touts les champs <c:out
												value="${ nombre_de_sujet }"></c:out></span>
									</div>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="page-header-breadcrumb">
									<ul class="breadcrumb-title">
										...
										<li class="breadcrumb-item"><a href="#!">Ajouter un
												sujet</a></li>
									</ul>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-sm-10">
								...
								<div class="card">
									...
									<form action="./ListSujetProposer" method="get">
										<h5>les sujets que vous avez proposez</h5>
										<button type="submit"
											class="btn btn-primary btn-outline-primary"
											id="btn_consulter">Consulter</button>
										</form>
									...
									<div class="card-block">
										...
										<form>
											<div class="form-group">
												<label for="exampleInputEmail1">Specialité*:</label> <select
													id="idSelect" name="select" class="form-control" required>
											...
											<div class="form-group">
												<label for="exampleInputEmail1">Titre*:</label> <input
													id="idTitre" type="text" name="titre" class="form-control"
													placeholder="Titre" required>
											</div>

											<div class="form-group">
												<label for="exampleTextarea">Description*:</label>
												<textarea id="idDesc" class="form-control" name="desc"
													id="exampleTextarea" rows="10" required></textarea>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-8">
													<button type="submit" class="btn btn-primary m-b-0"
														id="btnAjouter">Ajouter</button>
													<button class="btn btn-primary waves-effect"
														data-type="inverse"
														data-animation-in="animated bounceInRight"
														data-animation-out="animated bounceOutRight">Annuler</button>
												</div>
											</div>
										</form>
	...
	$(window)
			.on(
					...
					function() {
						...
						;
						notify(
								'il vous reste <c:out value="${ nombre_de_sujet }"></c:out> sujets a proposé ',
								'inverse');
