...
<c:choose>
	...
	<c:when test="${ not empty sessionScope.idEtudiant }">
							...
							<div class="row">
								...
								<div class="col-sm-8 user-detail">
									...
									<div class="row">
										...
										<div class="col-sm-7">
											<input type="Date" name="dateN" id="dateN" value="${sessionScope.dateEtudiant}"></input>
										</div>
									</div>
										<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30">
												<i class="icofont icofont-ui-adresse"></i>Moyenne :
											</h6>
										</div>
										<div class="col-sm-7">
											<h6 class="m-b-30">
												<input type="text" name="moyenne" id="moyenne" value="${sessionScope.moyEtudiant}"></input>
											</h6>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-sm-7">
											<h6 class="m-b-30">
												<input type="text" name="email" id="email" value="${sessionScope.emailEtudiant}"></input>
											</h6>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-sm-7">
											<input type="text" name="specialite" id="specialite" value="${sessionScope.specEtudiant}"></input>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-5">
										...
										<div class="col-sm-7">
											<input type="text" name="promotion" id="promotion" value="${sessionScope.promEtudiant}"></input>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-5">
											<h6 class="f-w-400 m-b-30">
												<i class="icofont icofont-web"></i>taux d'avencement :
											</h6>
										</div>
										<div class="col-sm-7">
											<h6 class="m-b-30">
												<input type="text" name="taux" id="taux" value="${sessionScope.tauxEtudiant}"></input>
											</h6>
										</div>
									</div>
								</div>
