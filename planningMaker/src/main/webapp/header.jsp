...
<link rel="stylesheet" type="text/css"
	href="assets/pages/prism/prism.css">
<!-- Style.css -->
<link rel="stylesheet" type="text/css" href="assets/css/style.css">
<link rel="stylesheet" type="text/css"
	href="assets/css/jquery.mCustomScrollbar.css">
<link rel="stylesheet" type="text/css"
	href="assets/css/pcoded-horizontal.min.css">
<!-- Notification.css -->
<link rel="stylesheet" type="text/css"
			...
			<div class="navbar-wrapper">
				...
				<div class="navbar-logo">
					<a class="mobile-menu" id="mobile-collapse" href="#!"> <i
						class="ti-menu"></i>
					</a> <a href="./AccueilCon"> <img class="img-fluid"
						src="assets/images/logoblan.png" />
				...
				<div class="pcoded-inner-navbar">
					...
					<ul class="pcoded-item pcoded-left-item" style="margin-left: 30%;">
						...
						<c:if test="${ !empty(sessionScope.idEtudiant)}">
							<li class="pcoded-hasmenu"><a href="AjouterFicheDeVoeux">
									<span class="pcoded-micon"><i class="ti-angle-right"></i><b>F</b></span>
									<span class="pcoded-mtext">Fiche de voeux</span> <span
									class="pcoded-mcaret"></span>
							</a></li>
							<li class="pcoded-hasmenu"><a href="javascript:void(0)">
									<span class="pcoded-micon"><i
										class="ti-layout-cta-right"></i><b>N</b></span> <span
									class="pcoded-mtext">Consulter</span> <span
									class="pcoded-mcaret"></span>
							</a>
								<ul class="pcoded-submenu">
									...
									<li class=""><a href="AffectationSujet"> <span
											class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
											class="pcoded-mtext" data-i18n="nav.dash.main">Liste
												affectation des sujets</span> <span class="pcoded-mcaret"></span>
									</a></li>
								</ul>
							<li class="pcoded-hasmenu"><a href="SoutenanceController">
									<span class="pcoded-micon"><i
						...
						<c:if test="${ !empty(sessionScope.idAgent)}">
							<li class="pcoded-hasmenu"><a href="javascript:void(0)">
									<span class="pcoded-micon"><i
										class="ti-layout-cta-right"></i><b>C</b></span> <span
									class="pcoded-mtext">Consulter</span> <span
									class="pcoded-mcaret"></span>
							</a>
								<ul class="pcoded-submenu">
							...
							<li class="pcoded-hasmenu"><a href="javascript:void(0)">
									<span class="pcoded-micon"><i
										class="ti-layout-cta-right"></i><b>F</b></span> <span
									class="pcoded-mtext">Faire</span> <span class="pcoded-mcaret"></span>
							</a>
								<ul class="pcoded-submenu">
									<li class=""><a href="AffectationSujet"> <span
							...
							<li class="pcoded-hasmenu"><a href="javascript:void(0)">
									<span class="pcoded-micon"><i
										class="ti-layout-cta-right"></i><b>A</b></span> <span
									class="pcoded-mtext">Ajouter</span> <span class="pcoded-mcaret"></span>
							</a>
								<ul class="pcoded-submenu">
									<li class=""><a href="ajouter_etudiant.jsp"> <span
											class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
											class="pcoded-mtext" data-i18n="nav.dash.main">Ajouter
												étudiant</span> <span class="pcoded-mcaret"></span>
									</a></li>
