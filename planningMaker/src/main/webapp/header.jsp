...
<link rel="stylesheet" type="text/css"
	href="assets/pages/data-table/css/buttons.dataTables.min.css">
<link rel="stylesheet" type="text/css"
...
<!-- Animate.css -->
<link rel="stylesheet" type="text/css"
	href="bower_components/animate.css/css/animate.css">
<body>
	<!-- Pre-loader start -->
				...
				<div class="navbar-wrapper">
					...
					<div class="navbar-logo">
						<a class="mobile-menu" id="mobile-collapse" href="#!"> <i
							class="ti-menu"></i>
						</a> <a href="fiche-de-voeux.jsp"> <img class="img-fluid"
					...
					<div class="navbar-container container-fluid">
						...
						<ul class="nav-right">
							<li class="user-profile header-notification"><a href="#!">
									...
									alt="User-Profile-Image"> <span>mekhezzem Reda</span> <i
									class="ti-angle-down"></i>
							</a>
								<ul class="show-notification profile-notification">
									<li><a href="#!"> <i class="ti-settings"></i> Settings
									</a></li>
									<li><a href="user-profile.html"> <i class="ti-user"></i>
											Profile
									</a></li>
									<li><a href="email-inbox.html"> <i class="ti-email"></i>
											My Messages
									</a></li>
						...
						<div class="pcoded-inner-navbar main-menu">
							<div class="">
								<div class="main-menu-header">
									...
									<div class="user-details">
										<span>mekhezzem Reda</span> <span id="more-details">Etudiant<i
								...
								<div class="main-menu-content">
									<ul>
										<li class="more-details"><a href="user-profile.html"><i
												...
												class="ti-settings"></i>Settings</a> <a href="login.jsp"><i
							...
							<ul class="pcoded-item pcoded-left-item">
								...
								<li class="pcoded-hasmenu active pcoded-trigger"><a
									...
									<ul class="pcoded-submenu">
										<li class=""><a href="AjouterFicheDeVoeux"> <span
												...
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Fiche
													de voeux</span> <span class="pcoded-mcaret"></span>
										</a></li>
									...
									<ul class="pcoded-submenu">
										<li class=""><a href="EtudiantController?Liste=132za&ze"> <span
												...
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Liste
													des etudiants</span> <span class="pcoded-mcaret"></span>
										</a></li>
									...
									<ul class="pcoded-submenu">
										<li class=""><a href="liste_agentAdmin.jsp"> <span
												...
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Liste
													des agents admins </span> <span class="pcoded-mcaret"></span>
										</a></li>

									</ul>
									<ul class="pcoded-submenu">
										<li class=""><a href="liste_enseignant.jsp"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Liste
									...
									<ul class="pcoded-submenu">
										<li class=""><a
											href="liste_plannification_soutenance.jsp"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Planning
													des soutenance</span> <span class="pcoded-mcaret"></span>
										</a></li>
									</ul>
									<ul class="pcoded-submenu">
										<li class=""><a href="affectation_sujet.jsp"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Affectation
													des sujets</span> <span class="pcoded-mcaret"></span>
										</a></li>
								...
								<li class="pcoded-hasmenu active pcoded-trigger"><a
									href="javascript:void(0)"> <span class="pcoded-micon"><i
											class="ti-layers"></i><b>FC</b></span> <span class="pcoded-mtext"
										data-i18n="nav.form-components.main">Ajouter</span> <span
										class="pcoded-mcaret"></span>
								</a>
									<ul class="pcoded-submenu">
										<li class=""><a href="ajouter_etudiant.jsp"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Ajouter
													etudiant</span> <span class="pcoded-mcaret"></span>
										</a></li>
									</ul>
									<ul class="pcoded-submenu">
										<li class=""><a href="ajouter_enseignant.jsp"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Ajouter
									...
									<ul class="pcoded-submenu">
										<li class=""><a href="ajouter_agentAdmin.jsp"> <span
												class="pcoded-micon"><i class="ti-angle-right"></i></span> <span
												class="pcoded-mtext"
												data-i18n="nav.form-components.form-validation">Ajouter
